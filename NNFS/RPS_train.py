...
def create_data_mnist(path):
	...
	X, y = load_mnist_dataset('rps_train', path)
	X_test, y_test = load_mnist_dataset('rps_test', path)

	# And return all the data
	return X, y, X_test, y_test

X, y, X_test, y_test = create_data_mnist('RockPaperScissors/Data_resized')
...
# Train the 		model
model.train(X, y, validation_data=(X_test, y_test), epochs=2, batch_size=32, print_every=100)

parameters = model.get_parameters()

model.save('RockPaperScissors.model')

model = Model.load('RockPaperScissors.model')


##--
RockPaperScissors_labels = {
	0: 'Rock',
	1: 'Paper', 
	2: 'Scissors',
	3: '3',
...
prediction = RockPaperScissors_labels[predictions[0]]
print(prediction)
