## All classes functioning together
...
# Creating samples 
X, y = spiral_data(samples= 1000, classes = 3) # X is input and y is output (if given x it should give y out)
...
dense2 = Layer_Dense(64, 3) #64 inputs features and 3 output
